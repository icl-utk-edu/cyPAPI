...
cdef extern from 'papi.h':
    ...
    cdef int _PAPI_PRESET_ENUM_FIRST_COMP "PAPI_PRESET_ENUM_FIRST_COMP"
    cdef int _PAPI_PRESET_ENUM_CPU "PAPI_PRESET_ENUM_CPU"
    cdef int _PAPI_PRESET_ENUM_CPU_AVAIL "PAPI_PRESET_ENUM_CPU_AVAIL"
